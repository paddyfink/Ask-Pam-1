...
// Author:
//   Miguel de Icaza
//   Github: https://github.com/xamarin/ios-samples/tree/master/Chat
//
...
namespace AskPam.iOS.CustomRenderers
{
    public class BubbleCell : UITableViewCell
    {
        ...
        public BubbleCell(AskPam.Models.Conversations.Message message, bool isSender)
            : base(UITableViewCellStyle.Default, isSender ? KeyRight : KeyLeft)
        {
        ...
        {
            var size = new SizeF((float)tv.Bounds.Width * .7f - 10 - 22, 99999);
            return size;
        }
